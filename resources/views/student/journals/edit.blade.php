...
<head>
    ...
    <title>Edit Journal Entry | Study Center</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="mengawali_hari_dengan_berdoa" id="berdoa_ya" value="1" {{ (old('mengawali_hari_dengan_berdoa', $journal->mengawali_hari_dengan_berdoa) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="berdoa_ya">YA</label>
                                            <input type="radio" class="btn-check" name="mengawali_hari_dengan_berdoa" id="berdoa_tidak" value="0" {{ (old('mengawali_hari_dengan_berdoa', $journal->mengawali_hari_dengan_berdoa) == '0') ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="baca_alkitab_pl" id="alkitab_pl_ya" value="1" {{ (old('baca_alkitab_pl', $journal->baca_alkitab_pl) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="alkitab_pl_ya">YA</label>
                                            <input type="radio" class="btn-check" name="baca_alkitab_pl" id="alkitab_pl_tidak" value="0" {{ (old('baca_alkitab_pl', $journal->baca_alkitab_pl) == '0') ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="baca_alkitab_pb" id="alkitab_pb_ya" value="1" {{ (old('baca_alkitab_pb', $journal->baca_alkitab_pb) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="alkitab_pb_ya">YA</label>
                                            <input type="radio" class="btn-check" name="baca_alkitab_pb" id="alkitab_pb_tidak" value="0" {{ (old('baca_alkitab_pb', $journal->baca_alkitab_pb) == '0') ? 'checked' : '' }}>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="hadir_kelas_sc" id="sc_ya" value="1" {{ (old('hadir_kelas_sc', $journal->hadir_kelas_sc) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="sc_ya">YA</label>
                                            <input type="radio" class="btn-check" name="hadir_kelas_sc" id="sc_tidak" value="0" {{ (old('hadir_kelas_sc', $journal->hadir_kelas_sc) == '0') ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="hadir_css" id="css_ya" value="1" {{ (old('hadir_css', $journal->hadir_css) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="css_ya">YA</label>
                                            <input type="radio" class="btn-check" name="hadir_css" id="css_tidak" value="0" {{ (old('hadir_css', $journal->hadir_css) == '0') ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="hadir_cgg" id="cgg_ya" value="1" {{ (old('hadir_cgg', $journal->hadir_cgg) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="cgg_ya">YA</label>
                                            <input type="radio" class="btn-check" name="hadir_cgg" id="cgg_tidak" value="0" {{ (old('hadir_cgg', $journal->hadir_cgg) == '0') ? 'checked' : '' }}>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="merapikan_tempat_tidur" id="rapikan_ya" value="1" {{ (old('merapikan_tempat_tidur', $journal->merapikan_tempat_tidur) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="rapikan_ya">YA</label>
                                            <input type="radio" class="btn-check" name="merapikan_tempat_tidur" id="rapikan_tidak" value="0" {{ (old('merapikan_tempat_tidur', $journal->merapikan_tempat_tidur) == '0') ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            <input type="radio" class="btn-check" name="menyapa_orang_tua" id="sapa_ya" value="1" {{ (old('menyapa_orang_tua', $journal->menyapa_orang_tua) == '1') ? 'checked' : '' }} required>
                                            <label class="btn btn-outline-primary" for="sapa_ya">YA</label>
                                            <input type="radio" class="btn-check" name="menyapa_orang_tua" id="sapa_tidak" value="0" {{ (old('menyapa_orang_tua', $journal->menyapa_orang_tua) == '0') ? 'checked' : '' }}>
